...
try: bot_token = os.environ.get("bot_token", "6564513574:AAGDqUaEmeu0m4DjLDetNc4nooVTWYT7Fzo")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{file_name}` Join @VJ_Botz")
